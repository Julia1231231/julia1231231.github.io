! function(e, t) {
    ...
    function re(e, t, n) {
        for (;
            (n < 0 ? 0 < t : t < e.length) && ne(e.charAt(t));)
            t += n;
        return t
    }
    ...
    function cn(e, t, n, r) {
        ...
        if (e.options.lineNumbers || i) {
            ...
            if (l.setAttribute("aria-hidden", "true"),
                ...
                t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || i && i["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(M("div", et(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
                i)
            ...
            if (!a.hidden) {
                i += a.line.height,
                    w && v < 8 ? (c = (s = a.node.offsetTop + a.node.offsetHeight) - n,
                        n = s) : (c = (d = a.node.getBoundingClientRect()).bottom - d.top, !u && a.text.firstChild && (h = a.text.firstChild.getBoundingClientRect().right - d.left - 1));
                                    ...
                                    for (var i = 0; i < 5; i++) {
                                        ...
                                        if (null != u.scrollTop && (Lr(e, u.scrollTop),
                                            ...
                                            null != u.scrollLeft && (Tr(e, u.scrollLeft),
                                                1 < Math.abs(e.doc.scrollLeft - a) && (l = !0)), !l)
                                            break
                                    }
                                    return o
    ...
    function Ur(e, t) {
        ...
        return 4 < o && (n.lineDiv.style.display = "none"),
            ...
            (i = l) && i.activeElt && i.activeElt != O() && (i.activeElt.focus(), !/^(INPUT|TEXTAREA)$/.test(i.activeElt.nodeName) && i.anchorNode && N(document.body, i.anchorNode) && N(document.body, i.focusNode) && (o = window.getSelection(),
            ...
            s && (n.lastWrapHeight = t.wrapperHeight,
                ...
                zr(e, 400)), !(n.updateLineNumbers = null)
    }
            ...
            if (u != s.length) {
                ...
                for (var h = Ce(i, "beforeChange") || i.cm && Ce(i.cm, "beforeChange"), d = l.changes.length - 1; 0 <= d; --d) {
                    var f = function(e) {
                        ...
                        c.push(wi(i, n));
                        var t = e ? ci(i, n) : Y(s);
                        _i(i, n, t, Mi(i, n)), !e && i.cm && i.cm.scrollIntoView({
                            from: n.from,
                            to: ai(n)
                        });
                        var r = [];
    ...
    function Yo(e) {
        ...
        e.target && e.target != i.display.input.getField() || (i.curOp.focus = O(),
            we(i, e) || (w && v < 11 && 27 == e.keyCode && (e.returnValue = !1),
                ...
                n = jo(i, e),
                p && (Xo = n ? t : null, !n && 88 == t && !Pe && (g ? e.metaKey : e.ctrlKey) && i.replaceSelection("", null, "cut")),
    ...
    function Cl(e, t, n, r) {
        ...
        for ("page" == r ? (i = Math.min(e.display.wrapper.clientHeight, window.innerHeight || document.documentElement.clientHeight),
                ...
                o = (0 < n ? t.bottom : t.top) + n * i) : "line" == r && (o = 0 < n ? t.bottom + 3 : t.top - 3);
            (l = Gn(e, a, o)).outside;) {
    ...
    e.prototype.init = function(e) {
        ...
        e.prototype.pollContent = function() {
            ...
            var o, l = i.line == n.viewFrom || 0 == (l = er(t, i.line)) ? (e = Ze(n.view[0].line),
                ...
                r = er(t, r.line),
                r = r == n.view.length - 1 ? (o = n.viewTo - 1,
    ...
    r.prototype.init = function(n) {
        ...
        Nl.prototype = {
            ...
            getTokenTypeAt: function(e) {
                e = at(this.doc, e);
                var t, n = ft(this, Ye(this.doc, e.line)),
                    r = 0,
                    i = (n.length - 1) / 2,
                    o = e.ch;
                if (0 == o)
            ...
            heightAtLine: function(e, t, n) {
                var r, i = !1,
                    e = "number" == typeof e ? (r = this.doc.first + this.doc.size - 1,
    ...
    return Se(ho),
        ...
        cl.fromTextArea = function(t, n) {
            ...
            if ((n = n ? P(n) : {}).value = t.value, !n.tabindex && t.tabIndex && (n.tabindex = t.tabIndex), !n.placeholder && t.placeholder && (n.placeholder = t.placeholder),
